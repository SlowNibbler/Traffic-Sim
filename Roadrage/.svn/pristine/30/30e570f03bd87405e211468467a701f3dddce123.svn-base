...
public class TruckTest {
    ...
    public void testReset() {
        ...
        t.reset();
        assertEquals("Truck setX failed!", 10, t.getX());
        assertEquals("Truck setY failed!", 11, t.getY());
    ...
    public void testCollide() {
        final Truck t = new Truck(10, 11, Direction.NORTH);
        final Truck v = new Truck(10, 12, Direction.SOUTH);
        t.collide(v);
    ...
    // Since the truck never dies, I couldn't come up with
    // any other way to test the poke method.
